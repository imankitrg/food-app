    ...
    <nav className="bg-[#0a0a0a] border-b border-orange-500/20 sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3">
          <img
            ...
            alt="FoodBite logo"
            className="h-30  w-50  padding-top-4 padding-bottom-5"
          />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-1">
          <Link
            href="/"
            className="px-3 py-2 rounded-lg text-sm font-medium text-orange-500 bg-orange-500/10 border border-orange-500/20 transition-all"
          >
            Home
          </Link>
          <Link
          ...
          <Link
            href="/cart"
            className="relative px-3 py-2 rounded-lg text-sm font-medium text-zinc-400 hover:text-white hover:bg-white/5 transition-all"
          >
            Cart
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#111] border-t border-orange-500/15 px-4 py-3 flex flex-col gap-1">
          <Link
            href="/"
            className="px-3 py-2.5 rounded-lg text-sm font-medium text-zinc-400 hover:text-white hover:bg-white/5 transition-all"
          >
            Home
          </Link>
          <Link
          ...
          <Link
            href="/auth"
            className="px-3 py-2.5 rounded-lg text-sm font-medium text-orange-500 bg-orange-500/10 border border-orange-500/20 transition-all"
          >
            Sign Up
          </Link>
        </div>
